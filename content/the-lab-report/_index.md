...
<style>
  ...
  .lr-indicators-showcase { max-width: 720px; margin: 0 auto 3rem; padding: 0 1rem; }
  .lr-indicator-tags { display: flex; flex-wrap: wrap; gap: 0.6rem; justify-content: center; }
  .lr-tag { display: inline-block; padding: 0.5rem 1.1rem; border-radius: 20px; font-size: 1.25rem; font-weight: 600; line-height: 1.4; }
  .lr-tag.momentum { background: rgba(59,130,246,0.12); color: #3b82f6; }
  .lr-tag.volume { background: rgba(168,85,247,0.12); color: #a855f7; }
  .lr-tag.trend { background: rgba(34,197,94,0.12); color: #22c55e; }
  .lr-tag.volatility { background: rgba(245,158,11,0.12); color: #f59e0b; }
  .lr-see-all { display: block; text-align: center; margin-top: 1.2rem; font-size: 1.35rem; font-weight: 600; color: var(--accent); text-decoration: none !important; }
  .lr-see-all:hover { text-decoration: underline !important; }
  ...
  .lr-promo { display: inline-block; background: var(--accent); color: #fff; border-radius: 6px; padding: 0.6rem 1.5rem; font-weight: 700; font-size: 1.3rem !important; letter-spacing: 0.3px; margin-top: 1rem; }
...
<div class="lr-hero">
  ...
  <a href="https://buy.stripe.com/9B64grdGmeWggu2fLbaAw0m" class="lr-cta" data-umami-event="stripe_click" data-umami-event-product="lab-report" data-umami-event-name="Lab Report" data-umami-event-price="$149/mo" data-umami-event-placement="hero">Subscribe at $149/mo →</a>
  <p class="lr-cta-sub">$149/month · Cancel anytime · 7-day free trial</p>
...
<div class="lr-trust">
  ...
  <span><strong>123</strong> indicators tracked</span>
  <span><strong>20</strong> markets covered</span>
  <span><strong>Every 15 min</strong> updates</span>
</div>

<div class="lr-indicators-showcase">
  <h2 style="font-size: 1.6rem; font-weight: 600; color: var(--text); margin: 0 0 1.2rem;">📊 Inside the Consensus Engine</h2>
  <div class="lr-indicator-tags">
    <span class="lr-tag momentum">RSI</span>
    <span class="lr-tag momentum">MACD</span>
    <span class="lr-tag volatility">Bollinger Bands</span>
    <span class="lr-tag volume">OBV</span>
    <span class="lr-tag volatility">ATR</span>
    <span class="lr-tag momentum">Stochastic</span>
    <span class="lr-tag trend">SuperTrend</span>
    <span class="lr-tag trend">Ichimoku</span>
    <span class="lr-tag volume">VWAP</span>
    <span class="lr-tag momentum">CCI</span>
    <span class="lr-tag trend">ADX</span>
    <span class="lr-tag volume">CVD</span>
    <span class="lr-tag volatility">TTM Squeeze</span>
    <span class="lr-tag momentum">Awesome Osc</span>
    <span class="lr-tag trend">Parabolic SAR</span>
    <span class="lr-tag volatility">Keltner Channels</span>
    <span class="lr-tag momentum">Connors RSI</span>
    <span class="lr-tag volume">Chaikin Osc</span>
    <span class="lr-tag momentum">KST</span>
    <span class="lr-tag trend">ALMA</span>
    <span class="lr-tag momentum">Center of Gravity</span>
    <span class="lr-tag volume">Whale Liquidity</span>
    <span class="lr-tag volatility">Ulcer Index</span>
    ...
    <span class="lr-tag trend">Liquidity Sweep</span>
    <span class="lr-tag momentum">Market Cipher B</span>
    <span class="lr-tag trend">Murrey Math Lines</span>
    <span class="lr-tag trend">Smart Money Concepts</span>
    <span class="lr-tag trend">AIS SuperTrend</span>
    <span class="lr-tag trend">Elliott Wave</span>
    <span class="lr-tag volume">Volume MA</span>
    <span class="lr-tag volatility">BB Squeeze</span>
    <span class="lr-tag trend">Jurik MA</span>
    <span class="lr-tag momentum">Cyber Cycle</span>
    <span class="lr-tag volume">Wyckoff A/D</span>
    <span class="lr-tag volume">NVI</span>
    <span class="lr-tag volatility">Adaptive BB</span>
    <span class="lr-tag trend">Kalman Filter</span>
    <span class="lr-tag trend">Wyckoff Spring</span>
    <span class="lr-tag volume">Williams A/D</span>
    <span class="lr-tag trend">Prev Day H/L</span>
    <span class="lr-tag volatility">GARCH</span>
  </div>
  <a href="/the-lab-report/indicators/" class="lr-see-all">See all 123 indicators →</a>
</div>
{{< /rawhtml >}}
...
<div class="lr-step">
  ...
  <div>
    ...
    <p>Every 15 minutes, our Telegram bot hits your phone: "BTCUSD: 55 of 123 indicators bullish — strong buy consensus."<br><strong>You check the chart. You decide. You act.</strong></p>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="lr-what">
  <h2>What This Is</h2>
  <p>The Lab Report is a <strong>multi-indicator consensus engine</strong>. 123 indicators across four categories — momentum, volume, trend, volatility — each vote BUY, SELL, or NEUTRAL on 20 hand-picked markets. Every 15 minutes, we tally the votes and send you the verdict.</p>
  <p>Think of it as a parliament of indicators. Not one noisy voice. 123 of them. When 55 or more agree on direction, you have something statistically sharper than any single indicator can produce — a consensus worth acting on, not another noisy signal.</p>
  ...
  <div class="lr-audience">
    <div>
      ...
      <ul>
        ...
        <li>You already have a system but want a second opinion. Cross-reference your analysis with 123 indicators aggregated in real time.</li>
    ...
    <div>
      ...
      <ul class="lr-not">
        ...
        <li>Your eyes can track 123 indicators across 20 markets, non-stop, round the clock. If that's you — you don't need a bot. You are the bot.</li>
...
When 55 of 123 indicators agree on direction, that's not a coincidence. That's a signal worth acting on.

**The science:** Most profitable trading systems use 3+ indicators per decision. The Lab Report aggregates the full roster — momentum, volume, trend, and volatility — so you read the consensus, not one noisy signal. 123 indicators and counting, as we add them to the roster.
...
<div class="lr-pricing" id="pricing">
  ...
  <div class="lr-price">$149 <span>/month</span></div>
  <p class="lr-price-sub">or <a href="https://buy.stripe.com/4gM6oz7hY15q1z8eH7aAw0n" style="color: var(--accent); text-decoration: underline;" data-umami-event="stripe_click" data-umami-event-product="lab-report" data-umami-event-name="Lab Report Annual" data-umami-event-price="$1,490/yr" data-umami-event-placement="pricing"><strong>$1,490/year</strong></a> (2 months free) · 7-day free trial · Cancel anytime</p>
  
  <a href="https://buy.stripe.com/9B64grdGmeWggu2fLbaAw0m" class="lr-cta" data-umami-event="stripe_click" data-umami-event-product="lab-report" data-umami-event-name="Lab Report" data-umami-event-price="$149/mo" data-umami-event-placement="pricing">Subscribe at $149/mo →</a>
...
<div class="lr-faq">
  ...
  <p><a href="/the-lab-report/indicators/" target="_blank" rel="noopener">→ See the current full list</a> — 123 indicators across momentum, volume, trend, and volatility. Updated weekly as we add new reviews.</p>
</div>
<div class="lr-faq">
...
<div class="lr-faq">
  ...
  <p>Yes. Choose monthly or annual at checkout. Current annual is <a href="https://buy.stripe.com/4gM6oz7hY15q1z8eH7aAw0n">$1,490/year</a> — that's $124.17/month, 2 months free vs monthly. Your locked-in price applies to both monthly or annual. If you subscribe annually, your annual renewal is locked in at your onboarded price along with the annual discount — forever! Even when the price increases as our product improves.</p>
</div>
<div class="lr-faq">
...
<div class="lr-close">
  ...
  <p>123 indicators. 20 markets. One verdict. Delivered to your phone every 15 minutes.</p>

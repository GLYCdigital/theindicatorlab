...
<div class="lr-trust">
  ...
  <span><strong>113</strong> indicators tracked</span>
...
<div class="lr-indicators-showcase">
  ...
  <a href="/the-lab-report/indicators/" class="lr-see-all">See all 113 indicators →</a>
</div>
{{< /rawhtml >}}
...
<div class="lr-step">
  ...
  <div>
    ...
    <p>Every 15 minutes, our Telegram bot hits your phone: "BTCUSD: 55 of 113 indicators bullish — strong buy consensus."<br><strong>You check the chart. You decide. You act.</strong></p>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="lr-what">
  <h2>What This Is</h2>
  <p>The Lab Report is a <strong>multi-indicator consensus engine</strong>. 113 indicators across four categories — momentum, volume, trend, volatility — each vote BUY, SELL, or NEUTRAL on 20 hand-picked markets. Every 15 minutes, we tally the votes and send you the verdict.</p>
  <p>Think of it as a parliament of indicators. Not one noisy voice. 113 of them. When 55 or more agree on direction, you have something statistically sharper than any single indicator can produce — a consensus worth acting on, not another noisy signal.</p>
  ...
  <div class="lr-audience">
    <div>
      ...
      <ul>
        ...
        <li>You already have a system but want a second opinion. Cross-reference your analysis with 113 indicators aggregated in real time.</li>
    ...
    <div>
      ...
      <ul class="lr-not">
        ...
        <li>Your eyes can track 113 indicators across 20 markets, non-stop, round the clock. If that's you — you don't need a bot. You are the bot.</li>
...
When 55 of 113 indicators agree on direction, that's not a coincidence. That's a signal worth acting on.

**The science:** Most profitable trading systems use 3+ indicators per decision. The Lab Report aggregates the full roster — momentum, volume, trend, and volatility — so you read the consensus, not one noisy signal. 113 indicators and counting, as we add them to the roster.
...
<div class="lr-faq">
  ...
  <p><a href="/the-lab-report/indicators/" target="_blank" rel="noopener">→ See the current full list</a> — 113 indicators across momentum, volume, trend, and volatility. Updated weekly as we add new reviews.</p>
</div>
<div class="lr-faq">
...
<div class="lr-close">
  ...
  <p>113 indicators. 20 markets. One verdict. Delivered to your phone every 15 minutes.</p>

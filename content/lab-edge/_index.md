...
<style>
  ...
  .le-section h2 { font-size: 3.5rem; font-weight: 700; margin: 0 0 1rem; color: var(--text); letter-spacing: -0.5px; text-align: center; }
  .le-section h2.xl { font-size: 5.5rem; letter-spacing: -1.5px; }

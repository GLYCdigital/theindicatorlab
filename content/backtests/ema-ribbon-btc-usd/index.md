...
Over five years (2021-07-14 → 2026-07-12), the EMA Ribbon delivered a **+106.1% total return** on BTC-USD, compounding at **15.6% annually**. 
...
| Trades/Year | ~32 total | Active |

The **profit factor of 1.73** tells the real story: when the EMA fires, the winning signals are larger than the losing ones. Combined with a 34.4% win rate, this requires careful position sizing to be profitable.

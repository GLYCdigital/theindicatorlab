...
Over five years (2021-06-14 → 2026-06-12), the TTM Squeeze Pro delivered a **+55.4% total return** on BTC-USD, compounding at **9.2% annually**. 
...
The **profit factor of 1.19** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 24.0% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on BTC?

The ttm squeeze pro shows moderate edge on BTC — **0.34 Sharpe, 1.19 profit factor** over 100 trades. It's not a home run, but it's also not random.

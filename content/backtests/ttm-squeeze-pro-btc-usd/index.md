...
Over five years (2021-09-27 → 2026-09-25), the TTM Squeeze Pro delivered a **+24.8% total return** on BTC-USD, compounding at **4.5% annually**. 
...
The **profit factor of 1.10** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 23.5% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on BTC?

The ttm squeeze pro struggled to generate meaningful edge on BTC over this 5-year period. With a **0.22 Sharpe ratio** and **1.10 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

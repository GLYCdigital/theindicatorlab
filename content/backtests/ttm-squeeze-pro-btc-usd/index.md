---
{
  ...
  "equity_curve_url": "/backtests/ttm-squeeze-pro-btc-usd-equity.png",
  "crosslinks": [
    {
...
![TTM Squeeze Pro — BTC-USD Equity Curve](/backtests/ttm-squeeze-pro-btc-usd-equity.png)
...
On BTC, the BollingerBands acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on BTC

Over five years (2021-05-31 → 2026-05-29), the TTM Squeeze Pro delivered a **+51.5% total return** on BTC-USD, compounding at **8.7% annually**. 

At **0.32**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Trades/Year | ~101 total | Active |

The **profit factor of 1.18** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 23.8% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on BTC?

The ttm squeeze pro shows moderate edge on BTC — **0.32 Sharpe, 1.18 profit factor** over 101 trades. It's not a home run, but it's also not random.

The 23.8% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.
...
![TTM Squeeze Pro — Trade Signals on BTC-USD](/backtests/ttm-squeeze-pro-btc-usd-trades.png)

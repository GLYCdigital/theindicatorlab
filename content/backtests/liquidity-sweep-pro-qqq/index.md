...
Over five years (2021-09-20 → 2026-09-18), the Liquidity Sweep Pro delivered a **+2.7% total return** on QQQ, compounding at **0.5% annually**. 
...
The **profit factor of 1.03** tells the real story: when the Sweep fires, the winning signals are larger than the losing ones. Combined with a 36.8% win rate, this requires careful position sizing to be profitable.

## Does the Liquidity Sweep Pro Work on QQQ?

The liquidity sweep pro struggled to generate meaningful edge on QQQ over this 5-year period. With a **0.01 Sharpe ratio** and **1.03 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

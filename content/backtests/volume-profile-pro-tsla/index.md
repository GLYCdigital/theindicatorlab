...
![Volume Profile Pro — TSLA Equity Curve](/backtests/volume-profile-pro-tsla-equity.png)
...
On TSLA, the VWAP acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on TSLA

Over five years (2021-09-13 → 2026-09-11), the Volume Profile Pro delivered a **+20.8% total return** on TSLA, compounding at **3.9% annually**. 

At **0.15**, the VWAP earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.06** tells the real story: when the VWAP fires, the winning signals are larger than the losing ones. Combined with a 28.4% win rate, this requires careful position sizing to be profitable.

## Does the Volume Profile Pro Work on TSLA?

The volume profile pro struggled to generate meaningful edge on TSLA over this 5-year period. With a **0.15 Sharpe ratio** and **1.06 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

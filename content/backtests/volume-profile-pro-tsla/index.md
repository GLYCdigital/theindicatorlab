...
Over five years (2021-06-14 → 2026-06-12), the Volume Profile Pro delivered a **+70.4% total return** on TSLA, compounding at **11.3% annually**. 
...
The **profit factor of 1.22** tells the real story: when the VWAP fires, the winning signals are larger than the losing ones. Combined with a 32.1% win rate, this requires careful position sizing to be profitable.

## Does the Volume Profile Pro Work on TSLA?

The volume profile pro shows moderate edge on TSLA — **0.39 Sharpe, 1.22 profit factor** over 81 trades. It's not a home run, but it's also not random.

The 32.1% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

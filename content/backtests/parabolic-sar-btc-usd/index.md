...
The **profit factor of 0.93** tells the real story: when the SAR fires, the winning signals don't outweigh the losers. Combined with a 32.9% win rate, this requires careful position sizing to be profitable.

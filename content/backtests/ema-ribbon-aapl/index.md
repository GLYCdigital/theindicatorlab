...
Over five years (2021-05-26 → 2026-05-22), the EMA Ribbon delivered a **+45.0% total return** on AAPL, compounding at **7.7% annually**. 
...
The **profit factor of 1.43** tells the real story: when the EMA fires, the winning signals are larger than the losing ones. Combined with a 30.4% win rate, this requires careful position sizing to be profitable.

## Does the EMA Ribbon Work on AAPL?

The ema ribbon shows moderate edge on AAPL — **0.39 Sharpe, 1.43 profit factor** over 23 trades. It's not a home run, but it's also not random.

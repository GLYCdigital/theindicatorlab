...
Over five years (2021-09-13 → 2026-09-11), the EMA Ribbon delivered a **+28.6% total return** on AAPL, compounding at **5.2% annually**. 

At **0.26**, the EMA earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The ema ribbon struggled to generate meaningful edge on AAPL over this 5-year period. With a **0.26 Sharpe ratio** and **1.45 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

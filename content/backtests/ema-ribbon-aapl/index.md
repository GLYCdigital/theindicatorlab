...
Over five years (2021-09-07 → 2026-09-04), the EMA Ribbon delivered a **+24.0% total return** on AAPL, compounding at **4.4% annually**. 

At **0.20**, the EMA earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The ema ribbon struggled to generate meaningful edge on AAPL over this 5-year period. With a **0.20 Sharpe ratio** and **1.45 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

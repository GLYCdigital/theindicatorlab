...
Over five years (2021-09-13 → 2026-09-11), the SuperTrend + ATR Trailing Stop delivered a **-23.7% total return** on QQQ, compounding at **-5.3% annually**. 
...
The supertrend + atr trailing stop struggled to generate meaningful edge on QQQ over this 5-year period. With a **-0.31 Sharpe ratio** and **0.88 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

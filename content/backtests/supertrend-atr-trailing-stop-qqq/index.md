...
Over five years (2021-08-30 → 2026-08-28), the SuperTrend + ATR Trailing Stop delivered a **-28.2% total return** on QQQ, compounding at **-6.4% annually**. 

At **-0.38**, the SuperTrend earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 43.7% | ⚠️ Below average |
| Profit Factor | 0.85 | ❌ Unprofitable |
| Trades/Year | ~300 total | Active |

The **profit factor of 0.85** tells the real story: when the SuperTrend fires, the winning signals don't outweigh the losers. Combined with a 43.7% win rate, this requires careful position sizing to be profitable.

## Does the SuperTrend + ATR Trailing Stop Work on QQQ?

The supertrend + atr trailing stop struggled to generate meaningful edge on QQQ over this 5-year period. With a **-0.38 Sharpe ratio** and **0.85 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

...
Over five years (2021-09-27 → 2026-09-25), the SuperTrend + ATR Trailing Stop delivered a **-22.9% total return** on QQQ, compounding at **-5.1% annually**. 
...
The **profit factor of 0.88** tells the real story: when the SuperTrend fires, the winning signals don't outweigh the losers. Combined with a 44.0% win rate, this requires careful position sizing to be profitable.

## Does the SuperTrend + ATR Trailing Stop Work on QQQ?

The supertrend + atr trailing stop struggled to generate meaningful edge on QQQ over this 5-year period. With a **-0.29 Sharpe ratio** and **0.88 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

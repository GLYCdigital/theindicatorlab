---
{
  ...
  "equity_curve_url": "/backtests/volume-spike-breakout-eth-usd-equity.png",
  "crosslinks": [
    {
...
![Volume Spike Breakout — ETH-USD Equity Curve](/backtests/volume-spike-breakout-eth-usd-equity.png)
...
Over five years (2021-05-26 → 2026-05-23), the Volume Spike Breakout delivered a **+50.3% total return** on ETH-USD, compounding at **8.5% annually**. 
...
The volume spike breakout shows moderate edge on ETH — **0.56 Sharpe, 2.20 profit factor** over 28 trades. It's not a home run, but it's also not random.

...
Over five years (2021-05-26 → 2026-05-23), the RSI Oversold/Overbought delivered a **-46.0% total return** on ETH-USD, compounding at **-11.6% annually**. 

At **-0.02**, the RSI earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 15.0% | ❌ Low — relies on outsized wins |
| Profit Factor | 0.66 | ❌ Unprofitable |
| Trades/Year | ~20 total | Selective — not overtrading |

The **profit factor of 0.66** tells the real story: when the RSI fires, the winning signals don't outweigh the losers. Combined with a 15.0% win rate, this requires careful position sizing to be profitable.

## Does the RSI Oversold/Overbought Work on ETH?

The rsi oversold/overbought struggled to generate meaningful edge on ETH over this 5-year period. With a **-0.02 Sharpe ratio** and **0.66 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

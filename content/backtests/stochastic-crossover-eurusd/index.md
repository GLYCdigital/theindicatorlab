...
Over five years (2021-06-28 → 2026-06-26), the Stochastic Crossover delivered a **-31.5% total return** on EURUSD=X, compounding at **-7.3% annually**. 

At **-2.89**, the Stochastic earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The stochastic crossover struggled to generate meaningful edge on EURUSD over this 5-year period. With a **-2.89 Sharpe ratio** and **0.46 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

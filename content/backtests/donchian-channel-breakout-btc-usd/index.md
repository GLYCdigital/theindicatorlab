...
Over five years (2021-07-12 → 2026-07-10), the Donchian Channel Breakout delivered a **+8.6% total return** on BTC-USD, compounding at **1.7% annually**. 
...
The **profit factor of 1.03** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 26.6% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on BTC?

The donchian channel breakout struggled to generate meaningful edge on BTC over this 5-year period. With a **0.16 Sharpe ratio** and **1.03 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

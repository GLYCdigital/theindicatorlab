...
Over five years (2021-08-30 → 2026-08-28), the Donchian Channel Breakout delivered a **+32.2% total return** on BTC-USD, compounding at **5.8% annually**. 

At **0.25**, the Donchian earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The donchian channel breakout struggled to generate meaningful edge on BTC over this 5-year period. With a **0.25 Sharpe ratio** and **1.05 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

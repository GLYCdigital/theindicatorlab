...
Over five years (2021-06-28 → 2026-06-26), the Bollinger Band Squeeze delivered a **+50.6% total return** on ETH-USD, compounding at **8.5% annually**. 
...
The bollinger band squeeze shows moderate edge on ETH — **0.31 Sharpe, 1.11 profit factor** over 92 trades. It's not a home run, but it's also not random.

...
![Bollinger Band Squeeze — ETH-USD Equity Curve](/backtests/bollinger-band-squeeze-eth-usd-equity.png)
...
Over five years (2021-08-30 → 2026-08-28), the Bollinger Band Squeeze delivered a **+45.8% total return** on ETH-USD, compounding at **7.8% annually**. 
...
The bollinger band squeeze shows moderate edge on ETH — **0.34 Sharpe, 1.05 profit factor** over 91 trades. It's not a home run, but it's also not random.

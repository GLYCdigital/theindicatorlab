...
Over five years (2021-09-13 → 2026-09-11), the Market Structure Pro delivered a **+18.6% total return** on TSLA, compounding at **3.5% annually**. 
...
The **profit factor of 1.05** tells the real story: when the Swing fires, the winning signals are larger than the losing ones. Combined with a 29.6% win rate, this requires careful position sizing to be profitable.

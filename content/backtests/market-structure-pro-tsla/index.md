...
Over five years (2021-06-28 → 2026-06-26), the Market Structure Pro delivered a **+86.4% total return** on TSLA, compounding at **13.3% annually**. 
...
The **profit factor of 1.23** tells the real story: when the Swing fires, the winning signals are larger than the losing ones. Combined with a 33.3% win rate, this requires careful position sizing to be profitable.

## Does the Market Structure Pro Work on TSLA?

The market structure pro shows moderate edge on TSLA — **0.40 Sharpe, 1.23 profit factor** over 69 trades. It's not a home run, but it's also not random.

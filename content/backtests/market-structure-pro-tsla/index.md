...
Over five years (2021-06-01 → 2026-05-27), the Market Structure Pro delivered a **+94.5% total return** on TSLA, compounding at **14.3% annually**. 

At **0.43**, the Swing earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.24** tells the real story: when the Swing fires, the winning signals are larger than the losing ones. Combined with a 32.9% win rate, this requires careful position sizing to be profitable.

## Does the Market Structure Pro Work on TSLA?

The market structure pro shows moderate edge on TSLA — **0.43 Sharpe, 1.24 profit factor** over 70 trades. It's not a home run, but it's also not random.

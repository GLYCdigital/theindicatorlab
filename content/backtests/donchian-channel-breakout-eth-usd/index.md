...
Over five years (2021-09-13 → 2026-09-11), the Donchian Channel Breakout delivered a **+24.0% total return** on ETH-USD, compounding at **4.4% annually**. 
...
The **profit factor of 1.08** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 23.4% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on ETH?

The donchian channel breakout struggled to generate meaningful edge on ETH over this 5-year period. With a **0.17 Sharpe ratio** and **1.08 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

...
Over five years (2021-05-26 → 2026-05-23), the Donchian Channel Breakout delivered a **+40.0% total return** on ETH-USD, compounding at **7.0% annually**. 
...
The **profit factor of 1.09** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 24.2% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on ETH?

The donchian channel breakout struggled to generate meaningful edge on ETH over this 5-year period. With a **0.26 Sharpe ratio** and **1.09 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

---
{
  ...
  "equity_curve_url": "/backtests/donchian-channel-breakout-eth-usd-equity.png",
  "crosslinks": [
    {
...
![Donchian Channel Breakout — ETH-USD Equity Curve](/backtests/donchian-channel-breakout-eth-usd-equity.png)
...
On ETH, the Donchian acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on ETH

Over five years (2021-06-28 → 2026-06-26), the Donchian Channel Breakout delivered a **+65.7% total return** on ETH-USD, compounding at **10.6% annually**. 

At **0.35**, the Donchian earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 24.5% | ❌ Low — relies on outsized wins |
| Profit Factor | 1.12 | ⚠️ Marginal |
| Trades/Year | ~94 total | Active |

The **profit factor of 1.12** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 24.5% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on ETH?

The donchian channel breakout shows moderate edge on ETH — **0.35 Sharpe, 1.12 profit factor** over 94 trades. It's not a home run, but it's also not random.

The 24.5% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

...
The **profit factor of 1.06** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 23.2% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on ETH?

The donchian channel breakout shows moderate edge on ETH — **0.33 Sharpe, 1.06 profit factor** over 95 trades. It's not a home run, but it's also not random.

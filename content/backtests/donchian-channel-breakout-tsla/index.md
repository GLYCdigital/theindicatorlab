...
Over five years (2021-06-07 → 2026-06-05), the Donchian Channel Breakout delivered a **+85.3% total return** on TSLA, compounding at **13.1% annually**. 
...
The **profit factor of 1.23** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 33.8% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on TSLA?

The donchian channel breakout shows moderate edge on TSLA — **0.40 Sharpe, 1.23 profit factor** over 71 trades. It's not a home run, but it's also not random.

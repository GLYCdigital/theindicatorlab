...
The **profit factor of 1.24** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 32.9% win rate, this requires careful position sizing to be profitable.

...
![Donchian Channel Breakout — TSLA Equity Curve](/backtests/donchian-channel-breakout-tsla-equity.png)
...
On TSLA, the Donchian acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on TSLA

Over five years (2021-07-06 → 2026-07-02), the Donchian Channel Breakout delivered a **+81.7% total return** on TSLA, compounding at **12.7% annually**. 

At **0.39**, the Donchian earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.23** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 33.3% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on TSLA?

The donchian channel breakout shows moderate edge on TSLA — **0.39 Sharpe, 1.23 profit factor** over 69 trades. It's not a home run, but it's also not random.

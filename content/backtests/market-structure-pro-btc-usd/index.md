...
Over five years (2021-06-21 → 2026-06-19), the Market Structure Pro delivered a **+50.2% total return** on BTC-USD, compounding at **8.5% annually**. 

At **0.32**, the Swing earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 28.0% | ❌ Low — relies on outsized wins |
| Profit Factor | 1.17 | ⚠️ Marginal |
| Trades/Year | ~93 total | Active |

The **profit factor of 1.17** tells the real story: when the Swing fires, the winning signals are larger than the losing ones. Combined with a 28.0% win rate, this requires careful position sizing to be profitable.

## Does the Market Structure Pro Work on BTC?

The market structure pro shows moderate edge on BTC — **0.32 Sharpe, 1.17 profit factor** over 93 trades. It's not a home run, but it's also not random.

The 28.0% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

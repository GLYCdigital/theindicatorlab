...
Over five years (2021-06-01 → 2026-05-29), the CVD Divergence Alerts delivered a **+20.8% total return** on SPY, compounding at **3.9% annually**. 

At **0.17**, the CVD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The cvd divergence alerts struggled to generate meaningful edge on SPY over this 5-year period. With a **0.17 Sharpe ratio** and **1.09 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

...
Over five years (2021-09-07 → 2026-09-04), the Bollinger Band Squeeze delivered a **+60.4% total return** on AAPL, compounding at **9.9% annually**. 
...
The bollinger band squeeze shows moderate edge on AAPL — **0.43 Sharpe, 1.58 profit factor** over 51 trades. It's not a home run, but it's also not random.

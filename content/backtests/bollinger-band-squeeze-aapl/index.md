...
Over five years (2021-06-01 → 2026-05-29), the Bollinger Band Squeeze delivered a **+57.1% total return** on AAPL, compounding at **9.5% annually**. 
...
The bollinger band squeeze shows moderate edge on AAPL — **0.41 Sharpe, 1.32 profit factor** over 52 trades. It's not a home run, but it's also not random.

...
Over five years (2021-07-06 → 2026-07-02), the Bollinger Band Squeeze delivered a **+52.5% total return** on AAPL, compounding at **8.8% annually**. 
...
The bollinger band squeeze shows moderate edge on AAPL — **0.38 Sharpe, 1.56 profit factor** over 52 trades. It's not a home run, but it's also not random.

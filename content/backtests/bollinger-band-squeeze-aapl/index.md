...
Over five years (2021-08-30 → 2026-08-28), the Bollinger Band Squeeze delivered a **+59.7% total return** on AAPL, compounding at **9.8% annually**. 
...
The bollinger band squeeze shows moderate edge on AAPL — **0.42 Sharpe, 1.58 profit factor** over 51 trades. It's not a home run, but it's also not random.

...
![Bollinger Band Squeeze — AAPL Equity Curve](/backtests/bollinger-band-squeeze-aapl-equity.png)
...
Over five years (2021-09-13 → 2026-09-11), the Bollinger Band Squeeze delivered a **+66.2% total return** on AAPL, compounding at **10.7% annually**. 
...
## Does the Bollinger Band Squeeze Work on AAPL?

The bollinger band squeeze shows moderate edge on AAPL — **0.46 Sharpe, 1.58 profit factor** over 51 trades. It's not a home run, but it's also not random.

...
Over five years (2021-09-13 → 2026-09-11), the Fisher Transform MTF Divergence delivered a **-28.9% total return** on SPY, compounding at **-6.6% annually**. 

At **-0.66**, the Fisher earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The fisher transform mtf divergence struggled to generate meaningful edge on SPY over this 5-year period. With a **-0.66 Sharpe ratio** and **0.77 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

...
Over five years (2021-09-20 → 2026-09-18), the Fisher Transform MTF Divergence delivered a **-29.6% total return** on SPY, compounding at **-6.8% annually**. 
...
The **profit factor of 0.77** tells the real story: when the Fisher fires, the winning signals don't outweigh the losers. Combined with a 42.0% win rate, this requires careful position sizing to be profitable.

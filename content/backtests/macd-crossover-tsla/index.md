...
Over five years (2021-09-20 → 2026-09-18), the MACD Crossover delivered a **+250.2% total return** on TSLA, compounding at **28.5% annually**. 

At **0.57**, the MACD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The macd crossover shows moderate edge on TSLA — **0.57 Sharpe, 1.94 profit factor** over 47 trades. It's not a home run, but it's also not random.

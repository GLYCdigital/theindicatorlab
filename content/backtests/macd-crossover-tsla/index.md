...
![MACD Crossover — TSLA Equity Curve](/backtests/macd-crossover-tsla-equity.png)
...
On TSLA, the MACD acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on TSLA

Over five years (2021-05-26 → 2026-05-22), the MACD Crossover delivered a **+334.6% total return** on TSLA, compounding at **34.2% annually**. 

At **0.66**, the MACD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Trades/Year | ~48 total | Active |

The **profit factor of 2.10** tells the real story: when the MACD fires, the winning signals are larger than the losing ones. Combined with a 35.4% win rate, this requires careful position sizing to be profitable.

## Does the MACD Crossover Work on TSLA?

The macd crossover shows moderate edge on TSLA — **0.66 Sharpe, 2.10 profit factor** over 48 trades. It's not a home run, but it's also not random.

The 35.4% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

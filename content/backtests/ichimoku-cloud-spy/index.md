...
Over five years (2021-08-23 → 2026-08-21), the Ichimoku Cloud delivered a **+50.9% total return** on SPY, compounding at **8.6% annually**. 
...
The **profit factor of 2.77** tells the real story: when the Ichimoku fires, the winning signals are larger than the losing ones. Combined with a 50.0% win rate, this is a mathematically sound edge.

## Does the Ichimoku Cloud Work on SPY?

The ichimoku cloud shows moderate edge on SPY — **0.48 Sharpe, 2.77 profit factor** over 20 trades. It's not a home run, but it's also not random.

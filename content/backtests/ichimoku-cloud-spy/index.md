...
Over five years (2021-06-01 → 2026-05-29), the Ichimoku Cloud delivered a **+52.3% total return** on SPY, compounding at **8.8% annually**. 
...
The ichimoku cloud shows moderate edge on SPY — **0.50 Sharpe, 2.39 profit factor** over 19 trades. It's not a home run, but it's also not random.

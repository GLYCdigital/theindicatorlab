...
![Volume Profile Pro — BTC-USD Equity Curve](/backtests/volume-profile-pro-btc-usd-equity.png)
...
On BTC, the VWAP acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on BTC

Over five years (2021-06-07 → 2026-06-05), the Volume Profile Pro delivered a **+66.8% total return** on BTC-USD, compounding at **10.8% annually**. 

At **0.37**, the VWAP earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 20.8% | ❌ Low — relies on outsized wins |
| Profit Factor | 1.24 | ⚠️ Marginal |
| Trades/Year | ~96 total | Active |

The **profit factor of 1.24** tells the real story: when the VWAP fires, the winning signals are larger than the losing ones. Combined with a 20.8% win rate, this requires careful position sizing to be profitable.

## Does the Volume Profile Pro Work on BTC?

The volume profile pro shows moderate edge on BTC — **0.37 Sharpe, 1.24 profit factor** over 96 trades. It's not a home run, but it's also not random.

The 20.8% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

...
Over five years (2021-06-21 → 2026-06-18), the Volume Profile Pro delivered a **+47.6% total return** on QQQ, compounding at **8.1% annually**. 

At **0.34**, the VWAP earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.49** tells the real story: when the VWAP fires, the winning signals are larger than the losing ones. Combined with a 40.0% win rate, this requires careful position sizing to be profitable.

## Does the Volume Profile Pro Work on QQQ?

The volume profile pro shows moderate edge on QQQ — **0.34 Sharpe, 1.49 profit factor** over 70 trades. It's not a home run, but it's also not random.

...
Over five years (2021-07-14 → 2026-07-12), the Liquidity Sweep Pro delivered a **-31.5% total return** on ETH-USD, compounding at **-7.3% annually**. 

At **-0.19**, the Sweep earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The liquidity sweep pro struggled to generate meaningful edge on ETH over this 5-year period. With a **-0.19 Sharpe ratio** and **0.89 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

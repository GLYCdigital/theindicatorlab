...
Over five years (2021-09-27 → 2026-09-25), the EMA Ribbon delivered a **+86.2% total return** on QQQ, compounding at **13.2% annually**. 

At **0.74**, the EMA earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The ema ribbon shows moderate edge on QQQ — **0.74 Sharpe, 3.86 profit factor** over 16 trades. It's not a home run, but it's also not random.

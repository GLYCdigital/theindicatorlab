...
Over five years (2021-08-30 → 2026-08-28), the Whale Liquidity / Absorption Profile delivered a **-0.5% total return** on SPY, compounding at **-0.1% annually**. 

At **-1.18**, the Volume earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 0.93** tells the real story: when the Volume fires, the winning signals don't outweigh the losers. Combined with a 50.0% win rate, this requires careful position sizing to be profitable.

## Does the Whale Liquidity / Absorption Profile Work on SPY?

The whale liquidity / absorption profile struggled to generate meaningful edge on SPY over this 5-year period. With a **-1.18 Sharpe ratio** and **0.93 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

...
Over five years (2021-05-26 → 2026-05-23), the Stochastic Crossover delivered a **-36.2% total return** on ETH-USD, compounding at **-8.6% annually**. 

At **-0.24**, the Stochastic earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 0.94** tells the real story: when the Stochastic fires, the winning signals don't outweigh the losers. Combined with a 35.0% win rate, this requires careful position sizing to be profitable.

## Does the Stochastic Crossover Work on ETH?

The stochastic crossover struggled to generate meaningful edge on ETH over this 5-year period. With a **-0.24 Sharpe ratio** and **0.94 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

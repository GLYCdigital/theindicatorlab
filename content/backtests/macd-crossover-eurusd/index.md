...
Over five years (2021-06-28 → 2026-06-26), the MACD Crossover delivered a **-12.3% total return** on EURUSD=X, compounding at **-2.6% annually**. 
...
The catch? A **14.2% max drawdown**. At some point during this 5-year run, you'd have been down nearly 14% from peak equity. That's significant territory for most traders. If you can't handle that kind of drawdown, this isn't for you — or you need to size down.

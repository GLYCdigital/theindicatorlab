...
Over five years (2021-06-14 → 2026-06-12), the Golden Cross delivered a **+94.7% total return** on GC=F, compounding at **14.3% annually**. 

At **0.50**, the SMA earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The golden cross shows moderate edge on GC=F — **0.50 Sharpe, 0.00 profit factor** over 2 trades. It's not a home run, but it's also not random.

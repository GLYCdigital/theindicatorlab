---
{
  ...
  "equity_curve_url": "/backtests/macd-crossover-spy-equity.png",
  "crosslinks": [
    {
...
![MACD Crossover — SPY Equity Curve](/backtests/macd-crossover-spy-equity.png)
...
On SPY, the MACD acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on SPY

Over five years (2021-09-27 → 2026-09-25), the MACD Crossover delivered a **+7.3% total return** on SPY, compounding at **1.4% annually**. 

At **-0.12**, the MACD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Trades/Year | ~54 total | Active |

The **profit factor of 1.14** tells the real story: when the MACD fires, the winning signals are larger than the losing ones. Combined with a 42.6% win rate, this requires careful position sizing to be profitable.

## Does the MACD Crossover Work on SPY?

The macd crossover struggled to generate meaningful edge on SPY over this 5-year period. With a **-0.12 Sharpe ratio** and **1.14 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

...
Over five years (2021-06-21 → 2026-06-18), the MACD Crossover delivered a **+13.6% total return** on SPY, compounding at **2.6% annually**. 
...
The **profit factor of 1.24** tells the real story: when the MACD fires, the winning signals are larger than the losing ones. Combined with a 42.6% win rate, this requires careful position sizing to be profitable.

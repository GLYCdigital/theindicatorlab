...
Over five years (2021-06-14 → 2026-06-12), the Volume Profile Pro delivered a **+13.5% total return** on AAPL, compounding at **2.6% annually**. 
...
The **profit factor of 1.12** tells the real story: when the VWAP fires, the winning signals are larger than the losing ones. Combined with a 36.7% win rate, this requires careful position sizing to be profitable.

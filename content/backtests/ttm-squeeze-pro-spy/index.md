...
Over five years (2021-07-14 → 2026-07-10), the TTM Squeeze Pro delivered a **+16.2% total return** on SPY, compounding at **3.1% annually**. 

At **0.11**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The ttm squeeze pro struggled to generate meaningful edge on SPY over this 5-year period. With a **0.11 Sharpe ratio** and **1.23 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

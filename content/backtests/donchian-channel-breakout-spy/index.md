---
{
  ...
  "equity_curve_url": "/backtests/donchian-channel-breakout-spy-equity.png",
  "crosslinks": [
    {
...
![Donchian Channel Breakout — SPY Equity Curve](/backtests/donchian-channel-breakout-spy-equity.png)
...
On SPY, the Donchian acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on SPY

Over five years (2021-09-20 → 2026-09-18), the Donchian Channel Breakout delivered a **+14.1% total return** on SPY, compounding at **2.7% annually**. 
...
The catch? A **22.2% max drawdown**. At some point during this 5-year run, you'd have been down nearly 22% from peak equity. That's significant territory for most traders. If you can't handle that kind of drawdown, this isn't for you — or you need to size down.
...
| Max Drawdown | 22.2% | ⚠️ Moderate |
| Win Rate | 29.2% | ❌ Low — relies on outsized wins |
| Profit Factor | 1.21 | ⚠️ Marginal |
| Trades/Year | ~65 total | Active |

The **profit factor of 1.21** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 29.2% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on SPY?

The donchian channel breakout struggled to generate meaningful edge on SPY over this 5-year period. With a **0.07 Sharpe ratio** and **1.21 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

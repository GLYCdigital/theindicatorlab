...
Over five years (2021-09-07 → 2026-09-04), the Donchian Channel Breakout delivered a **+18.6% total return** on SPY, compounding at **3.5% annually**. 

At **0.14**, the Donchian earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.27** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 30.3% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on SPY?

The donchian channel breakout struggled to generate meaningful edge on SPY over this 5-year period. With a **0.14 Sharpe ratio** and **1.27 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

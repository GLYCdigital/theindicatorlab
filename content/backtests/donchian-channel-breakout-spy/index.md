...
Over five years (2021-06-21 → 2026-06-18), the Donchian Channel Breakout delivered a **+15.7% total return** on SPY, compounding at **3.0% annually**. 
...
The **profit factor of 1.23** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 30.3% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on SPY?

The donchian channel breakout struggled to generate meaningful edge on SPY over this 5-year period. With a **0.10 Sharpe ratio** and **1.23 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

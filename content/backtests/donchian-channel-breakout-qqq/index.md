...
Over five years (2021-06-28 → 2026-06-26), the Donchian Channel Breakout delivered a **+33.3% total return** on QQQ, compounding at **5.9% annually**. 
...
The **profit factor of 1.36** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 29.9% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on QQQ?

The donchian channel breakout struggled to generate meaningful edge on QQQ over this 5-year period. With a **0.25 Sharpe ratio** and **1.36 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

...
Over five years (2021-06-07 → 2026-06-05), the TTM Squeeze Pro delivered a **+56.5% total return** on QQQ, compounding at **9.4% annually**. 

At **0.45**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The ttm squeeze pro shows moderate edge on QQQ — **0.45 Sharpe, 1.34 profit factor** over 65 trades. It's not a home run, but it's also not random.

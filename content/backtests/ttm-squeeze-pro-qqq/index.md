...
Over five years (2021-06-01 → 2026-05-29), the TTM Squeeze Pro delivered a **+60.6% total return** on QQQ, compounding at **9.9% annually**. 

At **0.48**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.34** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 32.3% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on QQQ?

The ttm squeeze pro shows moderate edge on QQQ — **0.48 Sharpe, 1.34 profit factor** over 65 trades. It's not a home run, but it's also not random.

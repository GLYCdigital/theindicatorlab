...
Over five years (2021-07-12 → 2026-07-10), the TTM Squeeze Pro delivered a **+45.0% total return** on QQQ, compounding at **7.7% annually**. 
...
The **profit factor of 1.46** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 30.4% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on QQQ?

The ttm squeeze pro shows moderate edge on QQQ — **0.36 Sharpe, 1.46 profit factor** over 69 trades. It's not a home run, but it's also not random.

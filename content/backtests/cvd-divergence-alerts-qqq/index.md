...
Over five years (2021-09-13 → 2026-09-11), the CVD Divergence Alerts delivered a **+40.8% total return** on QQQ, compounding at **7.1% annually**. 

At **0.32**, the CVD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 31.0% | ❌ Low — relies on outsized wins |
| Profit Factor | 1.41 | ⚠️ Marginal |
| Trades/Year | ~71 total | Active |

The **profit factor of 1.41** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 31.0% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on QQQ?

The cvd divergence alerts shows moderate edge on QQQ — **0.32 Sharpe, 1.41 profit factor** over 71 trades. It's not a home run, but it's also not random.

The 31.0% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

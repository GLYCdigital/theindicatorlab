...
Over five years (2021-06-21 → 2026-06-18), the CVD Divergence Alerts delivered a **+55.3% total return** on QQQ, compounding at **9.2% annually**. 
...
The **profit factor of 1.62** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 33.3% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on QQQ?

The cvd divergence alerts shows moderate edge on QQQ — **0.44 Sharpe, 1.62 profit factor** over 66 trades. It's not a home run, but it's also not random.

...
Over five years (2021-06-28 → 2026-06-26), the CVD Divergence Alerts delivered a **+47.3% total return** on QQQ, compounding at **8.1% annually**. 
...
The **profit factor of 1.51** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 31.8% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on QQQ?

The cvd divergence alerts shows moderate edge on QQQ — **0.38 Sharpe, 1.51 profit factor** over 66 trades. It's not a home run, but it's also not random.

...
Over five years (2021-08-30 → 2026-08-28), the CVD Divergence Alerts delivered a **+44.1% total return** on QQQ, compounding at **7.6% annually**. 

At **0.35**, the CVD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.47** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 31.4% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on QQQ?

The cvd divergence alerts shows moderate edge on QQQ — **0.35 Sharpe, 1.47 profit factor** over 70 trades. It's not a home run, but it's also not random.

...
Over five years (2021-09-07 → 2026-09-04), the CVD Divergence Alerts delivered a **+43.6% total return** on QQQ, compounding at **7.5% annually**. 
...
The **profit factor of 1.45** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 31.4% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on QQQ?

The cvd divergence alerts shows moderate edge on QQQ — **0.35 Sharpe, 1.45 profit factor** over 70 trades. It's not a home run, but it's also not random.

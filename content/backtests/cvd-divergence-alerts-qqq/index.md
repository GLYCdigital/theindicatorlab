...
Over five years (2021-06-01 → 2026-05-29), the CVD Divergence Alerts delivered a **+60.6% total return** on QQQ, compounding at **9.9% annually**. 

At **0.48**, the CVD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The cvd divergence alerts shows moderate edge on QQQ — **0.48 Sharpe, 1.34 profit factor** over 65 trades. It's not a home run, but it's also not random.

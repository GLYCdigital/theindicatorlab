...
Over five years (2021-06-21 → 2026-06-19), the Market Structure Pro delivered a **+72.1% total return** on ETH-USD, compounding at **11.5% annually**. 

At **0.37**, the Swing earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 24.7% | ❌ Low — relies on outsized wins |
| Profit Factor | 1.13 | ⚠️ Marginal |
| Trades/Year | ~93 total | Active |

The **profit factor of 1.13** tells the real story: when the Swing fires, the winning signals are larger than the losing ones. Combined with a 24.7% win rate, this requires careful position sizing to be profitable.

## Does the Market Structure Pro Work on ETH?

The market structure pro shows moderate edge on ETH — **0.37 Sharpe, 1.13 profit factor** over 93 trades. It's not a home run, but it's also not random.

The 24.7% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

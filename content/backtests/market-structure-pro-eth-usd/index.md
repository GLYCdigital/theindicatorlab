...
Over five years (2021-08-30 → 2026-08-28), the Market Structure Pro delivered a **+56.6% total return** on ETH-USD, compounding at **9.4% annually**. 

At **0.33**, the Swing earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.06** tells the real story: when the Swing fires, the winning signals are larger than the losing ones. Combined with a 23.2% win rate, this requires careful position sizing to be profitable.

## Does the Market Structure Pro Work on ETH?

The market structure pro shows moderate edge on ETH — **0.33 Sharpe, 1.06 profit factor** over 95 trades. It's not a home run, but it's also not random.

The 23.2% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

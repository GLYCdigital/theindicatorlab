...
Over five years (2021-06-07 → 2026-06-05), the Liquidity Sweep Pro delivered a **+53.3% total return** on AAPL, compounding at **8.9% annually**. 

At **0.49**, the Sweep earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Profit Factor | 1.26 | ⚠️ Marginal |
| Trades/Year | ~93 total | Active |

The **profit factor of 1.26** tells the real story: when the Sweep fires, the winning signals are larger than the losing ones. Combined with a 37.6% win rate, this requires careful position sizing to be profitable.

## Does the Liquidity Sweep Pro Work on AAPL?

The liquidity sweep pro shows moderate edge on AAPL — **0.49 Sharpe, 1.26 profit factor** over 93 trades. It's not a home run, but it's also not random.

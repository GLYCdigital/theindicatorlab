...
Over five years (2021-08-30 → 2026-08-28), the Liquidity Sweep Pro delivered a **+67.7% total return** on AAPL, compounding at **10.9% annually**. 

At **0.61**, the Sweep earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The liquidity sweep pro shows moderate edge on AAPL — **0.61 Sharpe, 1.46 profit factor** over 90 trades. It's not a home run, but it's also not random.

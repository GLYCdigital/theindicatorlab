...
Over five years (2021-09-27 → 2026-09-25), the Liquidity Sweep Pro delivered a **+77.8% total return** on AAPL, compounding at **12.2% annually**. 

At **0.67**, the Sweep earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
| Win Rate | 41.6% | ⚠️ Below average |
| Profit Factor | 1.51 | ✅ Good |
| Trades/Year | ~89 total | Active |

The **profit factor of 1.51** tells the real story: when the Sweep fires, the winning signals are larger than the losing ones. Combined with a 41.6% win rate, this requires careful position sizing to be profitable.

## Does the Liquidity Sweep Pro Work on AAPL?

The liquidity sweep pro shows moderate edge on AAPL — **0.67 Sharpe, 1.51 profit factor** over 89 trades. It's not a home run, but it's also not random.

The 41.6% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

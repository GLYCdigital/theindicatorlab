---
{
  ...
  "equity_curve_url": "/backtests/ttm-squeeze-pro-eth-usd-equity.png",
  "crosslinks": [
    {
...
![TTM Squeeze Pro — ETH-USD Equity Curve](/backtests/ttm-squeeze-pro-eth-usd-equity.png)
...
On ETH, the BollingerBands acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on ETH

Over five years (2021-09-06 → 2026-09-04), the TTM Squeeze Pro delivered a **+45.9% total return** on ETH-USD, compounding at **7.8% annually**. 

At **0.34**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.05** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 20.9% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on ETH?

The ttm squeeze pro shows moderate edge on ETH — **0.34 Sharpe, 1.05 profit factor** over 91 trades. It's not a home run, but it's also not random.

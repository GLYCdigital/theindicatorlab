...
Over five years (2021-06-28 → 2026-06-26), the TTM Squeeze Pro delivered a **+50.6% total return** on ETH-USD, compounding at **8.5% annually**. 
...
The **profit factor of 1.11** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 21.7% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on ETH?

The ttm squeeze pro shows moderate edge on ETH — **0.31 Sharpe, 1.11 profit factor** over 92 trades. It's not a home run, but it's also not random.

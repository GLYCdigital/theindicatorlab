...
Over five years (2021-08-30 → 2026-08-28), the MACD Crossover delivered a **+51.4% total return** on AAPL, compounding at **8.7% annually**. 
...
The **profit factor of 1.48** tells the real story: when the MACD fires, the winning signals are larger than the losing ones. Combined with a 42.6% win rate, this requires careful position sizing to be profitable.

## Does the MACD Crossover Work on AAPL?

The macd crossover shows moderate edge on AAPL — **0.43 Sharpe, 1.48 profit factor** over 47 trades. It's not a home run, but it's also not random.

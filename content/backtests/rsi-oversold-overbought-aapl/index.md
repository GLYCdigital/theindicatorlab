...
Over five years (2021-05-26 → 2026-05-22), the RSI Oversold/Overbought delivered a **+75.5% total return** on AAPL, compounding at **11.9% annually**. 
...
The **profit factor of 1.85** tells the real story: when the RSI fires, the winning signals are larger than the losing ones. Combined with a 33.3% win rate, this requires careful position sizing to be profitable.

## Does the RSI Oversold/Overbought Work on AAPL?

The rsi oversold/overbought shows moderate edge on AAPL — **0.52 Sharpe, 1.85 profit factor** over 12 trades. It's not a home run, but it's also not random.

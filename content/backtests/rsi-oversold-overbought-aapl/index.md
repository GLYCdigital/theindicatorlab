...
Over five years (2021-06-21 → 2026-06-18), the RSI Oversold/Overbought delivered a **+69.5% total return** on AAPL, compounding at **11.1% annually**. 

At **0.49**, the RSI earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The rsi oversold/overbought shows moderate edge on AAPL — **0.49 Sharpe, 1.85 profit factor** over 12 trades. It's not a home run, but it's also not random.

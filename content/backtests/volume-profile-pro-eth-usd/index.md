...
Over five years (2021-07-14 → 2026-07-12), the Volume Profile Pro delivered a **+71.1% total return** on ETH-USD, compounding at **11.3% annually**. 
...
The **profit factor of 1.21** tells the real story: when the VWAP fires, the winning signals are larger than the losing ones. Combined with a 21.0% win rate, this requires careful position sizing to be profitable.

## Does the Volume Profile Pro Work on ETH?

The volume profile pro shows moderate edge on ETH — **0.39 Sharpe, 1.21 profit factor** over 100 trades. It's not a home run, but it's also not random.

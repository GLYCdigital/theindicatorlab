...
Over five years (2021-07-12 → 2026-07-10), the Whale Liquidity / Absorption Profile delivered a **-1.4% total return** on BTC-USD, compounding at **-0.3% annually**. 

At **-0.35**, the Volume earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 0.96** tells the real story: when the Volume fires, the winning signals don't outweigh the losers. Combined with a 37.9% win rate, this requires careful position sizing to be profitable.

## Does the Whale Liquidity / Absorption Profile Work on BTC?

The whale liquidity / absorption profile struggled to generate meaningful edge on BTC over this 5-year period. With a **-0.35 Sharpe ratio** and **0.96 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

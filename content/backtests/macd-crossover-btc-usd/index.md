...
Over five years (2021-09-13 → 2026-09-11), the MACD Crossover delivered a **+53.0% total return** on BTC-USD, compounding at **8.9% annually**. 

At **0.31**, the MACD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The macd crossover shows moderate edge on BTC — **0.31 Sharpe, 1.25 profit factor** over 68 trades. It's not a home run, but it's also not random.

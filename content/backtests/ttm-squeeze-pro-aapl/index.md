...
Over five years (2021-07-14 → 2026-07-10), the TTM Squeeze Pro delivered a **+57.2% total return** on AAPL, compounding at **9.5% annually**. 
...
The **profit factor of 1.57** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 42.3% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on AAPL?

The ttm squeeze pro shows moderate edge on AAPL — **0.41 Sharpe, 1.57 profit factor** over 52 trades. It's not a home run, but it's also not random.

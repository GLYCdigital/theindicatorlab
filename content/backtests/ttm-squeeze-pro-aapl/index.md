...
![TTM Squeeze Pro — AAPL Equity Curve](/backtests/ttm-squeeze-pro-aapl-equity.png)
...
On AAPL, the BollingerBands acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on AAPL

Over five years (2021-08-23 → 2026-08-21), the TTM Squeeze Pro delivered a **+55.6% total return** on AAPL, compounding at **9.2% annually**. 

At **0.40**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.58** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 44.0% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on AAPL?

The ttm squeeze pro shows moderate edge on AAPL — **0.40 Sharpe, 1.58 profit factor** over 50 trades. It's not a home run, but it's also not random.

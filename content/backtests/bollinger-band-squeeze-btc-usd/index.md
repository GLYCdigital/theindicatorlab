...
![Bollinger Band Squeeze — BTC-USD Equity Curve](/backtests/bollinger-band-squeeze-btc-usd-equity.png)
...
Over five years (2021-05-26 → 2026-05-23), the Bollinger Band Squeeze delivered a **+51.5% total return** on BTC-USD, compounding at **8.7% annually**. 
...
The bollinger band squeeze shows moderate edge on BTC — **0.32 Sharpe, 1.18 profit factor** over 101 trades. It's not a home run, but it's also not random.

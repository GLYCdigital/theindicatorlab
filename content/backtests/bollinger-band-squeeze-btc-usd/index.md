...
Over five years (2021-06-14 → 2026-06-12), the Bollinger Band Squeeze delivered a **+55.4% total return** on BTC-USD, compounding at **9.2% annually**. 
...
The bollinger band squeeze shows moderate edge on BTC — **0.34 Sharpe, 1.19 profit factor** over 100 trades. It's not a home run, but it's also not random.

...
Over five years (2021-07-06 → 2026-07-02), the SuperTrend + ATR Trailing Stop delivered a **-19.7% total return** on SPY, compounding at **-4.3% annually**. 
...
The supertrend + atr trailing stop struggled to generate meaningful edge on SPY over this 5-year period. With a **-0.47 Sharpe ratio** and **0.87 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

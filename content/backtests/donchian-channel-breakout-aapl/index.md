...
Over five years (2021-09-20 → 2026-09-18), the Donchian Channel Breakout delivered a **+10.0% total return** on AAPL, compounding at **1.9% annually**. 
...
The **profit factor of 1.08** tells the real story: when the Donchian fires, the winning signals are larger than the losing ones. Combined with a 32.7% win rate, this requires careful position sizing to be profitable.

## Does the Donchian Channel Breakout Work on AAPL?

The donchian channel breakout struggled to generate meaningful edge on AAPL over this 5-year period. With a **0.07 Sharpe ratio** and **1.08 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

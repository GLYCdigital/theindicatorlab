...
Over five years (2021-06-01 → 2026-05-29), the Bollinger Band Squeeze delivered a **+60.6% total return** on QQQ, compounding at **9.9% annually**. 
...
The bollinger band squeeze shows moderate edge on QQQ — **0.48 Sharpe, 1.34 profit factor** over 65 trades. It's not a home run, but it's also not random.

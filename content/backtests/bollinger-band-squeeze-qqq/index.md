...
Over five years (2021-06-14 → 2026-06-12), the Bollinger Band Squeeze delivered a **+56.6% total return** on QQQ, compounding at **9.4% annually**. 
...
The bollinger band squeeze shows moderate edge on QQQ — **0.45 Sharpe, 1.65 profit factor** over 65 trades. It's not a home run, but it's also not random.

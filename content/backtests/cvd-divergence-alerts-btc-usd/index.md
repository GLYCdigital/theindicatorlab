---
{
  ...
  "equity_curve_url": "/backtests/cvd-divergence-alerts-btc-usd-equity.png",
  "crosslinks": [
    {
...
![CVD Divergence Alerts — BTC-USD Equity Curve](/backtests/cvd-divergence-alerts-btc-usd-equity.png)
...
On BTC, the CVD acts as a trend filter. It won't catch every exact bottom, but it reliably captures the meat of major moves while keeping you out of chop.

## 5-Year Performance on BTC

Over five years (2021-06-07 → 2026-06-05), the CVD Divergence Alerts delivered a **+51.5% total return** on BTC-USD, compounding at **8.7% annually**. 
...
The **profit factor of 1.18** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 23.8% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on BTC?

The cvd divergence alerts shows moderate edge on BTC — **0.32 Sharpe, 1.18 profit factor** over 101 trades. It's not a home run, but it's also not random.

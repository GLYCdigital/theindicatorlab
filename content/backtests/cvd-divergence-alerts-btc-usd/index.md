...
Over five years (2021-06-21 → 2026-06-19), the CVD Divergence Alerts delivered a **+62.5% total return** on BTC-USD, compounding at **10.2% annually**. 
...
The **profit factor of 1.21** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 24.2% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on BTC?

The cvd divergence alerts shows moderate edge on BTC — **0.36 Sharpe, 1.21 profit factor** over 99 trades. It's not a home run, but it's also not random.

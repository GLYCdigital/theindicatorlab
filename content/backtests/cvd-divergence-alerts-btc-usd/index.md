...
Over five years (2021-09-06 → 2026-09-04), the CVD Divergence Alerts delivered a **+47.6% total return** on BTC-USD, compounding at **8.1% annually**. 
...
The **profit factor of 1.09** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 23.5% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on BTC?

The cvd divergence alerts shows moderate edge on BTC — **0.31 Sharpe, 1.09 profit factor** over 102 trades. It's not a home run, but it's also not random.

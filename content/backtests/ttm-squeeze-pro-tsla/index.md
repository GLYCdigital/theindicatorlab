...
Over five years (2021-06-01 → 2026-05-29), the TTM Squeeze Pro delivered a **+137.3% total return** on TSLA, compounding at **18.9% annually**. 

At **0.55**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The ttm squeeze pro shows moderate edge on TSLA — **0.55 Sharpe, 1.37 profit factor** over 65 trades. It's not a home run, but it's also not random.

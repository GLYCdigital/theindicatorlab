...
Over five years (2021-07-14 → 2026-07-10), the TTM Squeeze Pro delivered a **+108.9% total return** on TSLA, compounding at **15.9% annually**. 

At **0.46**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.34** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 29.9% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on TSLA?

The ttm squeeze pro shows moderate edge on TSLA — **0.46 Sharpe, 1.34 profit factor** over 67 trades. It's not a home run, but it's also not random.

The 29.9% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

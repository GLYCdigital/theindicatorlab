...
Over five years (2021-07-06 → 2026-07-02), the TTM Squeeze Pro delivered a **+120.5% total return** on TSLA, compounding at **17.2% annually**. 

At **0.50**, the BollingerBands earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.41** tells the real story: when the BollingerBands fires, the winning signals are larger than the losing ones. Combined with a 30.8% win rate, this requires careful position sizing to be profitable.

## Does the TTM Squeeze Pro Work on TSLA?

The ttm squeeze pro shows moderate edge on TSLA — **0.50 Sharpe, 1.41 profit factor** over 65 trades. It's not a home run, but it's also not random.

...
Over five years (2021-06-14 → 2026-06-12), the CVD Divergence Alerts delivered a **+63.9% total return** on ETH-USD, compounding at **10.4% annually**. 
...
| Trades/Year | ~89 total | Active |

The **profit factor of 1.14** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 22.5% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on ETH?

The cvd divergence alerts shows moderate edge on ETH — **0.38 Sharpe, 1.14 profit factor** over 89 trades. It's not a home run, but it's also not random.

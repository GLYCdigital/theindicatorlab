...
Over five years (2021-06-21 → 2026-06-19), the CVD Divergence Alerts delivered a **+56.1% total return** on ETH-USD, compounding at **9.3% annually**. 
...
The **profit factor of 1.12** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 22.2% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on ETH?

The cvd divergence alerts shows moderate edge on ETH — **0.34 Sharpe, 1.12 profit factor** over 90 trades. It's not a home run, but it's also not random.

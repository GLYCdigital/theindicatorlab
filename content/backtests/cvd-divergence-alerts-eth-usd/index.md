...
Over five years (2021-06-28 → 2026-06-26), the CVD Divergence Alerts delivered a **+50.6% total return** on ETH-USD, compounding at **8.5% annually**. 

At **0.31**, the CVD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.11** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 21.7% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on ETH?

The cvd divergence alerts shows moderate edge on ETH — **0.31 Sharpe, 1.11 profit factor** over 92 trades. It's not a home run, but it's also not random.

The 21.7% win rate means you'll be wrong more than half the time. The profit factor above 1.0 means your wins are bigger than your losses, which is what keeps you profitable.

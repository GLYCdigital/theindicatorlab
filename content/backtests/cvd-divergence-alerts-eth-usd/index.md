...
Over five years (2021-09-13 → 2026-09-11), the CVD Divergence Alerts delivered a **+16.8% total return** on ETH-USD, compounding at **3.2% annually**. 

At **0.12**, the CVD earned less than one units of return for every unit of risk taken. For context, anything above 1.0 is considered good; above 1.5 is excellent.
...
The **profit factor of 1.06** tells the real story: when the CVD fires, the winning signals are larger than the losing ones. Combined with a 21.1% win rate, this requires careful position sizing to be profitable.

## Does the CVD Divergence Alerts Work on ETH?

The cvd divergence alerts struggled to generate meaningful edge on ETH over this 5-year period. With a **0.12 Sharpe ratio** and **1.06 profit factor**, the risk-adjusted returns are below what most systematic traders would consider acceptable.

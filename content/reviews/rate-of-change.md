---
title: "Rate of Change (ROC) — Review"
date: 2026-05-08
draft: false
type: reviews
tags:
...
Rate of Change (ROC) is a technical analysis tool focused on momentum and trend direction. Traders use it to identify momentum shifts and time entries and exits with greater precision. Like most indicators in its class, it works best when combined with price action context.
...
Rate of Change is a capable tool for traders focused on momentum and trend direction. Not flashy, not a silver bullet — but reliable when used in the right context. Learn its quirks and it'll earn its place on your chart.

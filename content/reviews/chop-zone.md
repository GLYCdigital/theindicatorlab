...
It's generally used on lower timeframes for scalping, though it can suit swing setups on higher timeframes as well. The algorithm combines ATR smoothing with a volatility ratio to filter noise.
...
- **Customizable sensitivity**: A "Chop Threshold" slider lets you dial sensitivity up or down, from very sensitive to only-extreme-chop.
- **Lightweight**: Runs smoothly across multiple charts.

## Settings and How to Tune Them

- **Timeframe**: Lower intraday timeframes for scalping, mid-range for day trading, higher timeframes for swings.
- **Chop Threshold**: Lower it for high-volatility assets like crypto; raise it for forex during low-liquidity hours.
- **Zone Length**: Shorter settings produce more zones but more false signals. Longer settings produce fewer zones but higher reliability.
- **Volume Filter**: Enable it. The best signals tend to come when volume spikes during a breakout from a red zone.

## How to Use It for Entries and Exits

**Entry strategy**: Wait for price to trade inside a red (chop) zone for several candles. Enter long when price breaks above the zone's upper boundary with a green candle and above-average volume. Place stop loss below the zone's midpoint.

**Exit strategy**: Take profit at the next major resistance level or when a new red zone forms above current price. Scalpers can target a fixed risk-reward exit.
...
**Cons:**
- Lags slightly during fast breakouts
...
- Can be over-sensitive on default settings for some assets (adjust threshold)

## Who It's Actually For

- **Scalpers**: Suited to the lowest intraday charts to avoid choppy ranges.
- **Day traders**: Use on mid-range intraday timeframes to time entries during trending sessions.
...
A: The zones are intended to remain fixed once formed, but confirm this behavior yourself before relying on it.

**Q: Can I use it for crypto?**  
A: Yes, but lower the Chop Threshold. Crypto chop zones are wider and more volatile.

**Q: What timeframes work best?**  
A: Lower intraday timeframes for day trading. Avoid the noisiest sub-minute charts and the highest timeframes, where zones become infrequent.

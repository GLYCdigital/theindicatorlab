...
<div style="text-align:center;padding:2rem 0 3rem;">
  <a href="https://buy.stripe.com/9B6bIT7hYeWgelU2YpaAw01" class="lr-cta" data-umami-event="stripe_click" data-umami-event-product="lab-originals" data-umami-event-name="Fisher Transform MTF" data-umami-event-price="$20" style="background:var(--accent);color:#fff!important;font-weight:700;padding:18px 52px;border-radius:var(--radius);font-size:1.6rem;text-decoration:none!important;box-shadow:0 2px 8px rgba(232,119,34,.3);">Get Fisher Transform MTF — $20</a>

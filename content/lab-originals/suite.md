...
{{< rawhtml >}}
<div style="text-align:center;padding:3rem 2rem;margin:3rem 0;background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%); border: 2px solid var(--accent); border-radius: var(--radius-lg); box-shadow: 0 4px 24px rgba(232,119,34,0.2);">

...
<div style="text-align:center;padding:2rem 0 3rem;">
  <a href="https://buy.stripe.com/fZu3cnauadSc1z8eH7aAw00" class="lr-cta" data-umami-event="stripe_click" data-umami-event-product="lab-originals" data-umami-event-name="CVD Divergence Alerts" data-umami-event-price="$25" style="background:var(--accent);color:#fff!important;font-weight:700;padding:18px 52px;border-radius:var(--radius);font-size:1.6rem;text-decoration:none!important;box-shadow:0 2px 8px rgba(232,119,34,.3);">Get CVD Divergence Alerts — $25</a>
